...
- **The dashboard's market lookup scans all program accounts** (`getProgramAccounts`) rather than using an index. Fine at hackathon scale; would not hold up with thousands of live markets.
